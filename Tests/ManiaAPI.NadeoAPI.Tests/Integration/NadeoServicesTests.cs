...
public class NadeoServicesTests
{
    ...
    public async void RequestManagement()
    {
        ...
        var login = configuration.GetValue<string>("UbisoftAccount:Login") ?? throw new Exception("UbisoftAccount:Login user secret is required");
        var password = configuration.GetValue<string>("UbisoftAccount:Password") ?? throw new Exception("UbisoftAccount:Password user secret is required");
